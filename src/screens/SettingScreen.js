...
export default class SettingScreen extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <Divider />
            <View style={{ width: wp('100'), height: 673, backgroundColor: '#f2f2f2', top: wp('10'), alignContent: "center", shadowColor: '#c8c8c8',
                ...
                <ScrollView contentContainerStyle={{
                    ...
                    <Card disabled={true} style={styles.cardTrackingContainer}>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("TrackCust")} >
                            ...
                            <Image style={{ left: wp('73.5%'), top: hp('-4.5%'), height: 17, width: 17 }} source={require("../../assets/pain.png")}></Image>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            ...
                            <Image style={{ left: wp('73.5%'), top: hp('-3%'), height: 17, width: 17 }} source={require("../../assets/pain.png")}></Image>
                        </TouchableOpacity>
                        </Card>
                        </View>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Reset")} >
                            <Text style={{ left: wp('0%'), top: hp('3%'), color: "#000", fontWeight: '500', fontSize: wp('4.5%'), }}>Login</Text>
                            <Text style={{ left: wp('0%'), top: hp('3.5%'), color: "#8A8A8E", fontWeight: '500',fontSize: wp('4%') }}>Change your password </Text>
                            <Text style={{ left: wp('0%'), top: hp('3%'), color: "#DFDFE0", fontWeight: '300', }}>_________________________________________________</Text>
                            <Image style={{ left: wp('73.5%'), top: hp('-4.5%'), height: 17, width: 17 }} source={require("../../assets/pain.png")}></Image>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.handleSignOut}>
                            <Text style={{ left: wp('0%'), top: hp('2%'), color: "#000", fontWeight: '500', fontSize: wp('4.5%'), }}>Sign out </Text>
                            {/* <Text style={{ left: wp('0%'), top: hp('2.5%'), color: "#8A8A8E", fontWeight: '500',fontSize: wp('4%') }}></Text> */}
                            <Text style={{ left: wp('0%'), top: hp('2%'), color: "#DFDFE0", fontWeight: '300' }}>_________________________________________________</Text>
                            <Image style={{ left: wp('73.5%'), top: hp('-3%'), height: 17, width: 17 }} source={require("../../assets/pain.png")}></Image>
                            </TouchableOpacity>
                        </Card>
