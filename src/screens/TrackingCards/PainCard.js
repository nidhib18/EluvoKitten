            ...
            <Layout style={TrackingStyles.container}>
                ...
                <Modal style={{
                    ...
                    <Card disabled={true}
                        ...
                        <Text style={{ color: '#8A8A8E', textAlign: 'left', top: Responsive.height(120), fontSize: Responsive.font(15), fontWeight: '500' }}>What type of pain was it?</Text>
                        <View style={{ top: Responsive.height(130), left: Responsive.width(-5) }}>
                            <TagSelector
                                tagStyle={TrackingStyles.tag}
                                selectedTagStyle={TrackingStyles.tagSelected}
                                maxHeight={70}
